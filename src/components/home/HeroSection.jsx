...
export default function HeroSection() {
    ...
    return (
        <section className="relative bg-[radial-gradient(19.33%_167.96%_at_50%_50%,rgba(255,255,255,0.25)_0%,rgba(19,75,150,0.25)_100%)]">
            <div className="relative min-h-[86dvh] secGap flex flex-col justify-center bg-white">
                ...
                <div className="relative w-full mx-auto flex items-center justify-between gap-[6%] px-[5%] max-[1023px]:flex-col max-[800px]:justify-center max-[800px]:py-9">
                    <div className="flex-1 py-12 max-[800px]:py-4 w-full">
                        <h1 className="m-0 text-[26px] md:text-[32px] lg:text-[clamp(1.75rem,0.2089rem+1.8051vw,2.375rem)] font-medium leading-[1.34] text-white lg:text-ink">
                        ...
                        <p className="my-[1.3333em] text-[14px] md:text-[16px] lg:text-[clamp(0.9375rem,0.4752rem+0.5415vw,1.125rem)] leading-relaxed text-white lg:text-ink max-[800px]:text-[15px]">
                        ...
                        <div className="flex gap-[18px] max-[480px]:flex-col">
                            <Link
                                href="/contact-us"
                    ...
                    >
                        ...
                        <label className="relative text-sm font-semibold">
                            ...
                            />
                            <span className="flex justify-between text-[11px] md:text-[13px] lg:text-[clamp(0.75rem,0.4418rem+0.361vw,0.875rem)] text-white mt-[1.25em]">
            ...
            <div className="[@media(max-width:1023px)]:py-(--sec-gap) px-[4%] lg:absolute lg:-bottom-12 lg:inset-x-0 z-10 mx-auto grid max-w-290 grid-cols-4 gap-5 max-[1024px]:grid-cols-2 max-[480px]:grid-cols-1">
                {stats.map(([Icon, value, label]) => (
                    <div
                        key={label}
                        className="text-center flex items-center justify-center gap-4 rounded-xl bg-white/55 backdrop-blur-lg px-4 py-5 shadow-[2px_2px_4px_rgba(0,0,0,0.25)] transition hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(16,25,43,0.18)]"
                    >
                        <div>
                            <p className="m-0 text-2xl font-bold text-[#10192b]">
                                {value}
                            </p>
                            <p className="m-0 text-[11px] md:text-[13px] lg:text-[clamp(0.75rem,0.4418rem+0.361vw,0.875rem)] uppercase tracking-wider text-[#4B5563]">
                                {label}
                            </p>
                        </div>
                    </div>
