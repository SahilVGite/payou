...
function StepCard({ number, icon: Icon, title, description, tag }) {
  return (
    <div className="flex h-full flex-col rounded-[18px] bg-[#E3E5EA]/35 px-6 py-8 shadow-[0px_10px_30px_-8px_rgba(0,0,0,0.21),inset_0px_10px_15px_-10px_rgba(0,0,0,0.1)] backdrop-blur-xs transition hover:-translate-y-1 hover:shadow-[0_16px_36px_rgba(16,25,43,0.14),inset_0px_10px_15px_-10px_rgba(0,0,0,0.15)]">
