  ...
  return (
    ...
    >
      <div className="mx-auto max-w-(--content-width)">
        <h2 className="mb-2.5 text-center text-[28px] md:text-[36px] lg:text-[clamp(2rem,0.4589rem+1.8051vw,2.625rem)] text-ink">
          From Application to Bank Disbursal in <strong className="font-bold text-primary">4 Simple Steps</strong>
        </h2>
        <p className="mx-auto text-center text-[16px] md:text-[18px] lg:text-[clamp(1rem,0.3836rem+0.722vw,1.25rem)] text-[#4B5563] mb-[3.8em]">
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          {steps.map(({ number, icon: Icon, title, description, tag }) => (
            ...
            >
              ...
              <h3 className="mt-[1em] text-[16px] md:text-[18px] lg:text-[clamp(1rem,0.3836rem+0.722vw,1.25rem)] font-bold text-primary">{title}</h3>
