  ...
  return (
    <section className="overflow-hidden bg-primary secGap px-[4%]">
      <div className="mx-auto max-w-(--content-width)">
        <h2 className="mb-2.5 text-center text-[28px] md:text-[36px] lg:text-[clamp(2rem,0.4589rem+1.8051vw,2.625rem)] text-white">
          Backed by 50+ Top Banks, <strong className="font-bold">NBFCs &amp; Fintech Institutions</strong>
        </h2>
        <p className="mb-(--sec-gap) text-center text-[16px] md:text-[18px] lg:text-[clamp(1rem,0.3836rem+0.722vw,1.25rem)] text-white/70">
